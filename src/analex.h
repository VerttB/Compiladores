...
typedef enum {
    ...
    NEGACAO,DIFERENTE,VIRGULA,CHAVEABERTA,CHAVEFECHADA
} SINAL;

typedef enum{
    CONST,INIT, ENDP, CHAR, INT, REAL, BOOL, DO, WHILE,ENDW, VAR, FROM, TO,BY,ENDV,IF,ELIF,ELSE,ENDI
    ,GETINT,GETCHAR,GETREAL,PUTINT,PUTCHAR,PUTREAL,DT, GETOUT, PUTSTR, GETSTR, PROT, DEF
}PVR;

extern char keywords[31][20];
